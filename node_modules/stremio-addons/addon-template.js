...
buf.push("\n");
jade_debug.unshift(new jade.DebugItem( 46, jade_debug[0].filename ));
buf.push(".icon { float: left; width: 60px; height: 40px; margin: 20px; background-color: #eaeaea; -webkit-mask-repeat: no-repeat; -moz-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; -moz-mask-position: center; mask-position: center; -webkit-mask-size: contain; -moz-mask-size: contain; mask-size: contain; }");
jade_debug.shift();
buf.push("\n");
jade_debug.unshift(new jade.DebugItem( 46, jade_debug[0].filename ));
buf.push("");
...
{
jade_debug.unshift(new jade.DebugItem( 52, "addon-template.jade" ));
jade_debug.unshift(new jade.DebugItem( 52, "addon-template.jade" ));
buf.push("<style>");
jade_debug.unshift(new jade.DebugItem( 54, jade_debug[0].filename ));
jade_debug.unshift(new jade.DebugItem( 54, jade_debug[0].filename ));
buf.push("html { background-image: url('http://www.strem.io/3.0/background-6.jpg'); background-size: auto 100%; background-size: cover; background-repeat: no-repeat; }");
jade_debug.shift();
buf.push("\n");
jade_debug.unshift(new jade.DebugItem( 54, jade_debug[0].filename ));
buf.push("");
...
jade_debug.unshift(new jade.DebugItem( 60, "addon-template.jade" ));
buf.push("<div" + (jade.attr("style", "-webkit-mask-image: url(" + (addon.manifest.icon) + "); -moz-mask-image: url(" + (addon.manifest.icon) + "); mask-image: url(" + (addon.manifest.icon) + ")", true, true)) + " class=\"icon\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.shift();
buf.push("</div>");
jade_debug.shift();
...
buf.push("</div>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 92, "addon-template.jade" ));
buf.push("<script src=\"https://code.jquery.com/jquery-2.1.4.min.js\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.shift();
buf.push("</script>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 93, "addon-template.jade" ));
if ( endpoint)
{
jade_debug.unshift(new jade.DebugItem( 94, "addon-template.jade" ));
jade_debug.unshift(new jade.DebugItem( 94, "addon-template.jade" ));
buf.push("<script>");
